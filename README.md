...
# Oakland Athletics Historical Timeline
...
The timeline above shows the history of Major League Baseball's Oakland Athletics. The Athletics have a long and storied history, dating back to their times in Philadelphia, Kansas City, and now Oakland. The data information stems from mlb.com. 
...
The data above shows the percent of Lehigh students in the college of arts and sciences, business, and engineering. As shown, most Lehigh students are in the college of arts and sciences. This data comes from https://oirsa.lehigh.edu/sites/oirsa.lehigh.edu/files/LUprofile_2021.pdf.

# Lehigh University Housing Residency
...
The bar graphs above shows the Lehigh University housing residency among undergraduate students. As shown, most students live in residence halls. This data comes from https://oirsa.lehigh.edu/sites/oirsa.lehigh.edu/files/LUprofile_2021.pdf.

# 2017 Life Satisifaction and GDP Per Capita
...
The scatter plot above shows the life satisfaction and GDP Per Capita. As shown, the highest life satisfaction was roughly 8.00 when the GDP was 40585.721. This data comes from ourworldindata.org. 

# Oakland Athletics Wins By Season (2010-2021) 
...
The data above shows the Oakland Athletics' wins by season from 2010-2021. The one major outlier here comes in 2020 when they had 36 wins in 60 games. Over a normal 162 game season, like the other years, this equivalents to 97 wins. This information comes from MLB.com. 
...
The interactive map above shows where in the world the 10 largest sports stadiums are located. Those that are located in the United States are all college football stadiums. This data comes from topendsports.com. 
...
The data shows the location preference for Lehigh parties based off of which Lehigh affiliated group students are a part of. The location preferences are Greek houses, off-campus, or no preference. The groups are in a greek fraternity or sorority, varsity athletic team, or neither. This information came from a Lehigh University survey. 

# Higher Education of the United States in 2013
...
The interactive map above shows the higher education of different colleges and universities throughout the United States. It shows the admissions totals of over 1,000 institutions with varying levels of degree offered, private and public universities, number of international students, and the higest degree offered. This information comes from a 2013 Higher Education Dataset on data.gov. 

# Treasury Reporting Rates of Exchange and Fiscal Quarter and Currency
...
This graph shows the Treasury Reporting Rates of Exchange and the Fiscal Quarter and Currency of countries throughout the world. Latin America has the highest rate of exchange in the world and the higest currency fiscal quarter. The data stems from https://fiscaldata.treasury.gov/datasets/treasury-reporting-rates-exchange/treasury-reporting-rates-of-exchange. 
